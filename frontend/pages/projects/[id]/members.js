...
export default function ProjectMembers() {
  ...
  const _accept = useAcceptApplicant().accept;
  const _reject = useRejectApplicant().reject;
  const accept = (project && project.owner == user._id) ? _accept : undefined
  const reject = (project && project.owner == user._id) ? _reject : undefined
