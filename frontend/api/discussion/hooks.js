...
import { GetCommentsRequest, CreateCommentRequest, DeleteCommentRequest } from './requests'
...
export function useCreateComment(projectId) {
  ...
  const createComment = async (body, parent) => {
    return await CreateCommentRequest({projectId, owner: user._id, body, parent})
  }
